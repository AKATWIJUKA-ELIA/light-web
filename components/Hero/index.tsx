...
const Hero = () => {
  ...
  return (
      <div  className="-ml-28 flex flex-col md:flex-row md:gap-10 relative min-h-screen " style={{ backgroundImage:`url('/images/color-sharp.png')`,backgroundRepeat:'no-repeat',backgroundSize:'cover',backgroundPosition:'center', backgroundBlendMode:'multiply'}} >
